<?php
	...
	$answers = $answers[0];
	$sum = $answers['ans21'] + $answers['ans22'] + $answers['ans23'] + $answers['ans24'] + $answers['ans25'] + $answers['ans26'];

    if($sum < 3)
    {
    	render('display.php', array('message' => "Solve atleast 3 questions in Level 2 to enter Final Level.", 'text' => 'FINAL LEVEL'));
    }
